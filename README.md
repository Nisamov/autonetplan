...
Como broma, se ha decidido añadir mensajes de error en Klingon, unicamente visibles cuando no se ha establecido un idioma dentro del fichero establecido, o bien, este idioma no se ha reconocido por el programa.
